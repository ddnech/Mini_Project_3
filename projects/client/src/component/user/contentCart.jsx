            ...
            <div className="flex-col gap-1">
                                    ...
                                    <div className="flex-col items-end h-fit">
                                        ...
                                        <div className="sm:flex font-ysa">
                                            ...
                                            <div className="w-fit font-josefin text-xs grid items-end px-1 hover:underline">
                                                <button type="submit" onClick={() => handleRemoveCart(item.product.id)}>
                                                    remove from cart
                                                </button>
                                            </div>
                                        </div>
                ...
                <div>
                    <Modal show={modalOpen} size="md" popup={true} onClose={handleCloseModal}>
                        <Modal.Header><span className="text-base font-lora px-2 sm:text">One More Step to Checkout</span></Modal.Header>
                        <Modal.Body>
                                            ...
                                            <Form>
                                                <div className='grid grid-flow-row gap-1 justify-center'>
                                                    <div className='grid grid-flow-row gap-3 w-60'>
                                                        <div>
                                                            <label htmlFor="address" className="font-josefin text-sm">Address:</label>
                                                            <Field type={"text"} id="address" name="address" className='border border-gray-300 h-6 text-xs w-full focus:border-darkgreen focus:ring-0' placeholder='Enter your address here.' />
                                                            <ErrorMessage name="address" component="div" className="text-red-500 text-sm px-2 mt-1" />
                                                        </div>
                                                    </div>

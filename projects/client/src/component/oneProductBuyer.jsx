                    ...
                    <div className="addtocart flex mx-auto gap-2">
                        <div className="flex justify-center">
                            <div className="flex items-center border border-gray-300 px-3 py-2">
                                <button className="text-gray-500 hover:text-gray-700 focus:outline-none" onClick={reduceQuantity}>
                                ...
                                <button className="text-gray-500 hover:text-gray-700 focus:outline-none" onClick={addQuantity}>
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex">
                            <button
                                className={`mx-auto w-32 py-2 text-xs font-josefin tracking-wide border ${(isProductInCart || quantity > 0) ? "bg-darkgreen text-flashwhite hover:bg-white hover:text-darkgreen hover:border-darkgreen" : "bg-gray-300 text-gray-500 cursor-not-allowed"
                                    }`}
                                onClick={handleSubmit}
                                disabled={!isProductInCart && quantity === 0}
                            >
                                {isProductInCart && quantity === 0 ? "Remove from Cart" : "Add to Cart"}
                            </button>
                        </div>
                    </div>
                </div>
